...
class BlogAdapter(private val context: Context, private val posts: ArrayList<org.metabrainz.android.model.blog.Post>, private val clickListener: ClickListener) : RecyclerView.Adapter<BlogAdapter.ViewHolder>() {
