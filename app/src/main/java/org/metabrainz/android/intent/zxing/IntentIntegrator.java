...
package org.metabrainz.android.intent.zxing;
 ...
 * 
 * <p>
 * Integration is essentially as easy as calling {@link #initiateScan(AppCompatActivity)}
 * and waiting for the result in your app.
 * </p>
 * 
 * <p>
 * It does require that the Barcode Scanner application is installed. The
 * {@link #initiateScan(AppCompatActivity)} method will prompt the user to download the
 * application, if needed.
 * </p>
 * 
 * <p>
 * There are a few steps to using this integration. First, your {@link AppCompatActivity}
 * must implement the method {@link AppCompatActivity#onActivityResult(int, int, Intent)}
 ...
 * <p>
 * You can use
 * {@link #initiateScan(AppCompatActivity, CharSequence, CharSequence, CharSequence, CharSequence)}
 * or {@link #initiateScan(AppCompatActivity, int, int, int, int)} to customize the
 * download prompt with different text labels.
 * </p>
 * 
 * <p>
 * Note that {@link #initiateScan(AppCompatActivity)} returns an {@link AlertDialog}
 ...
 * {@link AppCompatActivity#onPause()} method.
 * </p>
 * 
 ...
 * {@link #shareText(AppCompatActivity, CharSequence)}.
 * </p>
 * 
 * <p>
...
public final class IntentIntegrator {
     ...
     */
    public static AlertDialog initiateScan(AppCompatActivity activity) {
     ...
     * See
     * {@link #initiateScan(AppCompatActivity, CharSequence, CharSequence, CharSequence, CharSequence)}
     * -- same, but takes string IDs which refer to the {@link AppCompatActivity}'s
     * resource bundle entries.
     */
    public static AlertDialog initiateScan(AppCompatActivity activity, int stringTitle, int stringMessage, int stringButtonYes,
                                                                  int stringButtonNo) {
    ...
    /**
     * See
     * {@link #initiateScan(AppCompatActivity, CharSequence, CharSequence, CharSequence, CharSequence, CharSequence)}
     ...
     *         app, null otherwise
     */
    public static AlertDialog initiateScan(AppCompatActivity activity, CharSequence stringTitle, CharSequence stringMessage,
    ...
    private static AlertDialog showDownloadDialog(final AppCompatActivity activity, CharSequence stringTitle,
    ...
    /**
     * <p>
     * Call this from your {@link AppCompatActivity}'s
     * {@link AppCompatActivity#onActivityResult(int, int, Intent)} method.
     * </p>
     * 
    ...
    /**
     * See
     * {@link #shareText(AppCompatActivity, CharSequence, CharSequence, CharSequence, CharSequence, CharSequence)}
     * -- same, but uses default English labels.
     */
    public static void shareText(AppCompatActivity activity, CharSequence text) {
     ...
     * resource bundle entries.
     */
    public static void shareText(AppCompatActivity activity, CharSequence text, int stringTitle, int stringMessage,
     ...
     *            Scanner (e.g. "No")
     */
    public static void shareText(AppCompatActivity activity, CharSequence text, CharSequence stringTitle,
                                 CharSequence stringMessage, CharSequence stringButtonYes, CharSequence stringButtonNo) {
