...
@Singleton
class TaggerRepositoryImpl @Inject constructor(private val service: TaggerService) : TaggerRepository{

    override fun fetchRecordings(query: String?): LiveData<List<Recording>> {
    ...
    override fun fetchMatchedRelease(MBID: String?): LiveData<Release?> {
    ...
    override fun fetchAcoustIDResults(duration: Long, fingerprint: String?): LiveData<List<Recording>> {
        val recordingResponseData = MutableLiveData<List<Recording>>()
