package org.metabrainz.mobile.async.external;

import java.io.IOException;

import org.metabrainz.mobile.async.PersistingAsyncTaskLoader;
import org.metabrainz.mobile.async.external.result.ArtistBio;
import org.metabrainz.mobile.async.external.result.LastFmArtist;
